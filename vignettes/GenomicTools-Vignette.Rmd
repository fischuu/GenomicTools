...
vignette: |
  %\VignetteIndexEntry{An Introduction to GenomicTools} %\VignetteEngine{knitr::rmarkdown} %\usepackage[utf8]{inputenc}
---
...
# Make the example data available
  ...
  data("genotDataVCF") # An imported vcf file, using importVCF
```
