...
A raw annotation file in gtf ASCII format will be available for download from 

[http://genomictools.danielfischer.name/datasets/annotTrack.gtf](http://genomictools.danielfischer.name/datasets/annotTrack.gtf)
